...
def test_D2_with_normal_data():
    ...
    test_img_name_list = ['145053828_e0e748717c_b.jpg']
    ...
    img_name_list = __manager_test__.get_img_name_list(test_normal_path)
    ...
    assert img_name_list == test_img_name_list
...
def test_D3_with_normal_data():
    ...
    test_img_name_list = [
        '145053828_e0e748717c_b.jpg', '145053828_e0e748717c_b.jpg',
    ...
    img_name_list = __manager_test__.get_img_name_list(test_path)
...
def test_D3_with_D3_data():
    ...
    test_img_name_list = [
        '0021_18-57-01_28057__1_G.tiff', '0021_18-57-01_28057__1_H.tiff',
        '0021_18-57-01_28057__1_G.tiff'
    ]
    ...
    img_name_list = __manager_test__.get_img_name_list(test_gray_path)
